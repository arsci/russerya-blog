...
ogImage: "van_electrical/part_1/electrical_diagram_2.png"
---
...
less current). Since I recently purchased a 3D printer, not only am I [able to print custom mounts and wire boxes for each space as well](https://shop.brightwrenchdesign.com/products/buck-converter-mounting-kit-w-junction-box-24v-12v-3d-printed-1),
but I can print my own [custom clips](https://shop.brightwrenchdesign.com/products/mounting-clip-1-2-od-loom-pack-of-5) and [mounting brackets](https://shop.brightwrenchdesign.com/products/150a-dc-circuit-breaker-mounting-kit).