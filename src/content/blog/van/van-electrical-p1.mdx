...
less current). Since I recently purchased a 3D printer, [I'm able to print custom mounts and wire boxes for each space as well](https://shop.brightwrenchdesign.com/products/buck-converter-mounting-kit-w-junction-box-24v-12v-3d-printed-1).